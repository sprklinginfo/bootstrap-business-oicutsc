 ...
 * Page alter.
 */
function bootstrap_business_oicutsc_page_alter($page) {
 ...
 */
function bootstrap_business_oicutsc_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
	if (theme_get_setting('bootstrap_js_include', 'bootstrap_business_oicutsc')) {
	drupal_add_js(drupal_get_path('theme', 'bootstrap_business_oicutsc') . '/bootstrap/js/bootstrap.min.js');
	}
	//EOF:Javascript
	...
	*/
	if (theme_get_setting('scrolltop_display', 'bootstrap_business_oicutsc')) {
 ...
 */
function bootstrap_business_oicutsc_process_html(&$vars) {
 ...
 */
function bootstrap_business_oicutsc_preprocess_page(&$vars) {
	...
	/* Enable page.tpl.php based on content type */
 ...
 */
function bootstrap_business_oicutsc_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function bootstrap_business_oicutsc_preprocess_block(&$variables) {
 ...
 */
function bootstrap_business_oicutsc_breadcrumb($variables) {
 ...
 */
function bootstrap_business_oicutsc_form_alter(&$form, &$form_state, $form_id) {
